...
import com.chromakeyland.placeholder.Adapter
...
class TimelineHandler(
    ...
    private val timelineAdapter =null
    private val halfScreenWidth = com.chromakeyland.placeholder.BlankFragment.context.getResources().getDisplayMetrics().widthPixels / 2
   ...
   private fun seekPlayer() {
    ...
    private val timerObservable: io.reactivex.Observable<PlaybackInfo>
        get() =
            io.reactivex.Observable.interval(PLAYBACK_POLL_DURATION, TimeUnit.MILLISECONDS)
